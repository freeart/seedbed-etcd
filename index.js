...
module.exports = function () {
	...
	this.etcd = () => {
		...
		const filename = path.resolve(path.join(__dirname, `../../json/etcd-${process.env.NODE_ENV}.json`));
		const backup = path.resolve(path.join(__dirname, `../../json/etcd-${process.env.NODE_ENV}.json.bak`));
